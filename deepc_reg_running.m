...
%    - Shift past window - could be improved by increasing the past window length.
%    - Repeat
%
%% =========================================================
...
% Expecting at least:
% Ad, Bd, Cd, Dd, Up, Uf, Xp, Xf, Tini, Ts, Npred
...
ncol = size(Up,2);      % columns in Hankel matrices
...
% Initial state
x0 = [0.0; 0.00; 0.15; 0.00];

% Constant state reference
r_stage = [0.2; 0.0; 0.0; 0.0];
...
for t = 1:Nsim
    ...
    %% //TODO: ADD TERMINAL CONSTRAINTS AND FEASIBILITY CHECKS - done
    ...
    % Propagate plant- Since we don't have real plant measurements.
